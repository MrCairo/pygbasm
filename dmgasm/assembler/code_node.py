...
CodeOffset_ = namedtuple("CodeOffset",
                         "offset reference_frame reference_detail")


class CodeOffset(CodeOffset_):
    """
    The Offset value of a CodeNode.
...
class CodeNode(object):
    """
    CodeNode is a piece of code, label or memory.
    ...
    def __str__(self):
        """Print a CodeNode object for debugging."""
        desc = "\n"
